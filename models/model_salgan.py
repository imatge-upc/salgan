...
class ModelSALGAN (Model):
    def __init__(self, w, h, batch_size, G_lr=3e-4, D_lr=3e-4, alpha=1 / 20.):
        ...
        # prediction_upsampled = T.nnet.abstract_conv.bilinear_upsampling(prediction, 8, batch_size=self.batch_size,
        ...
        # output_var_pooled = T.signal.pool.pool_2d(self.output_var, (8, 8), mode="average_exc_pad", ignore_border=True)
