...
def build(inputHeight, inputWidth, input_var):
    ...
    net['fconv1'] =  batch_norm(ConvLayer(net['pool5'], 1, 1, pad=0))
    print "fconv1: {}".format(net['fconv1'].output_shape[1:])
    net['output'] = ConvLayer(net['fconv1'], 1, 1, pad=0,nonlinearity=sigmoid)
